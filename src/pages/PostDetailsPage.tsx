...
function ChevronLeftIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.4">
...
function Toggle() {
  ...
  return (
    ...
    >
      <span className={`h-[20px] w-[20px] rounded-full ${enabled ? "bg-gradient-to-r from-amber to-orange" : "bg-muted"}`} />
    </button>
  );
}
    ...
    <div className="min-h-screen bg-page font-outfit text-ink">
      ...
      <main className="mx-auto flex w-full max-w-[1512px] flex-col items-center px-[20px] pb-[80px] pt-[36px] sm:px-[40px] lg:pb-[100px]">
        <div className="relative mb-[18px] grid h-[54px] w-full max-w-[420px] place-items-center rounded-[28px] bg-white px-6">
          <button className="absolute left-[22px] flex items-center gap-1 text-[15px] text-[#9c98a5]" onClick={() => navigate("/post")}>
            <ChevronLeftIcon />
            Back
          </button>
        ...
        <section className="w-full max-w-[420px] rounded-[28px] bg-white px-[20px] pb-[24px] pt-[24px] sm:px-[24px]">
          <div className="space-y-[28px]">
            <TextField label="Condition" placeholder="Is it new, used, which?" />
          ...
          <div className="mt-[26px] flex items-center justify-between gap-4">
            <span className="text-[16px] text-[#9c98a5]">Exchange available</span>
            <Toggle />
          </div>
