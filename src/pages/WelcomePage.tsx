  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f3f3f5] font-outfit text-[#1f1f29]">
      ...
      <main className="mx-auto flex h-[calc(100vh-96px)] max-w-[1728px] flex-col items-center justify-center px-4 pb-[90px]">
        ...
        <h1 className="mb-[6px] text-[30px] font-semibold leading-[1.1] text-[#2f2f35] sm:text-[34px]">Welcome to Qwik.ng</h1>
        <p className="mb-[22px] text-[16px] font-normal text-[#9695a1] sm:text-[18px]">A place where you Buy and Sell qwik qwik</p>

        <button
          onClick={() => navigate("/")}
          className="h-[54px] w-[435px] rounded-[10px] bg-gradient-to-r from-[#ffb900] to-[#ff6b0a] text-[18px] text-white shadow-[0_10px_22px_rgba(255,128,17,0.28)] sm:text-[20px]"
        >
          Start Shopping
        </button>
      </main>
