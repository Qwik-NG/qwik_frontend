            ...
            {loading ? (
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between gap-4">
                  <p className="min-w-0 text-[15px] text-[#9794a1] sm:text-[16px]">Deals, recommendations, news</p>
                  <Toggle size="sm" checked={settings.pushNotifications} onCheckedChange={(checked) => updateSetting("pushNotifications", checked)} />
                </div>
                <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  <p className="min-w-0 text-[15px] text-[#9794a1] sm:text-[16px]">Other useful Info</p>
