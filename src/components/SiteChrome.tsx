...
export function SiteHeader({ navigate }: { navigate: NavigateTo }) {
  return (
    <header className="mx-auto flex w-full max-w-[1728px] items-center gap-6 px-12 pt-8">
      <button className="relative h-[96px] w-[96px] shrink-0 overflow-hidden rounded-full bg-white" onClick={() => navigate("/")}>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button className="h-14 rounded-[11px] bg-gradient-to-r from-amber to-orange px-5 text-[16px] text-white shadow-glow" onClick={() => navigate("/signup")}>
          Post a free ad
        </button>
      </div>
    </header>
